...
Supp_Figure9 <- ggplot(admix_sharing) +
...
Supp_Figure9
ggsave(paste("plots/Supplemental Figure 9.pdf"), width = 7.5, height = 7.5)

# Write data for supplemental figure 9
# admix_sharing %>%
...
#   readr::write_csv(., "data/elife_files/supp-fig9-data1.csv")
